...
2. 使用CNN、word2vec预测va值
 ...
 ```python
 N_fm = 100, kernel_size = 3, maxlen = 100, hidden_dims = 100, dropout_p = 0.5, pool_length = pool_length=math.floor((maxlen-kernel_size+1)/2), batch_size = 8, max_nb_epoch=50
 ```
 Experiement result:

 |Metrics|MSE|MAE|pearson_r|R2|Spearman_r|rMSE|
 |----|----|----|----|----|----|----|
 |Valence|1.193|0.883|0.623|0.372|0.651|1.092|
 ...
 ```
 1607/1607 [==============================] - 8s - loss: 1.4043 - val_loss: 1.0504
 Epoch 2/50
 1607/1607 [==============================] - 8s - loss: 1.1146 - val_loss: 0.9685
 Epoch 3/50
 1607/1607 [==============================] - 8s - loss: 0.9957 - val_loss: 0.8977
 Epoch 4/50
 1607/1607 [==============================] - 8s - loss: 0.9306 - val_loss: 0.8895
 Epoch 5/50
 1607/1607 [==============================] - 8s - loss: 0.8729 - val_loss: 0.8917
 Epoch 6/50
 1607/1607 [==============================] - 8s - loss: 0.8479 - val_loss: 0.8801
 Epoch 7/50
 1607/1607 [==============================] - 8s - loss: 0.8106 - val_loss: 0.8977
 Epoch 8/50
 1607/1607 [==============================] - 8s - loss: 0.7625 - val_loss: 0.9071
 Epoch 9/50
 1607/1607 [==============================] - 8s - loss: 0.7742 - val_loss: 0.9147
 Epoch 10/50
 1607/1607 [==============================] - 8s - loss: 0.7709 - val_loss: 0.9247
 Epoch 11/50
 1607/1607 [==============================] - 8s - loss: 0.7370 - val_loss: 0.8991
 Epoch 12/50
 1607/1607 [==============================] - 8s - loss: 0.7392 - val_loss: 0.9427
 Epoch 13/50
 1607/1607 [==============================] - 8s - loss: 0.7008 - val_loss: 0.9027
 Epoch 14/50
 1607/1607 [==============================] - 8s - loss: 0.6922 - val_loss: 0.9018
 Epoch 15/50
 1607/1607 [==============================] - 8s - loss: 0.7096 - val_loss: 0.9228
 Epoch 16/50
 1607/1607 [==============================] - 8s - loss: 0.7126 - val_loss: 0.8843
 Epoch 17/50
 1607/1607 [==============================] - 8s - loss: 0.6550 - val_loss: 0.8833
 ```
 迭代过程图
